...
docker run --name wordpress -itd -p 8888:80 --link mysql:mysql -v `pwd`/themes:/var/www/html/wp-content/themes -v `pwd`/uploads:/var/www/html/wp-content/uploads -e WORDPRESS_DEBUG=true ${PREFIX}-compcon
